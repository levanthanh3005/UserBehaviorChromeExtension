    ...
    for min_char_length in range(3,8):
        for max_words_length in range(3,6):
            for min_keyword_frequency in range(1,7):
                ...
                keyword = []
                try:
                    keyword = rake_object.run(test_doc)[0]
                except :
                    continue
                avg_fmeasure = keyword[1]
                ...
                # print(min_char_length, max_words_length, min_keyword_frequency, "\t", avg_fmeasure,"\t", keyword)
                # print(best_keywords)
